...
$query=mysqli_query($conn,"select * from user_form where id='".$_SESSION['adminid']."'");
$totalusers=mysqli_fetch_array($query);
...
<html lang="en">
    <head>
        ...
        <title> Dashboard | Registration and Login</title>
...
?>
                           <?php if($userRole=='admin' || $userRole=='Front Office' || $userRole=='user') { ?>
...
?>
                             <?php if($userRole=='admin' || $userRole=='Front Office' || $userRole=='Manager') { ?>
                            <div class="col-xl-3 col-md-6">
